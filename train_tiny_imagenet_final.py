...
from dataset import Classification_ImageDataset
...
def log_hparams(wb_logger, cfg):
    if not cfg.fast_dev_run:
        ...
        # Set run name
        wb_logger.experiment.name = cfg.log.run_name
...
def main(cfg):
    ...
    train_dataset = Classification_ImageDataset(
        root_dir=cfg.imagenet_train_data_dir,
        #image_paths_pkl=cfg.image_paths_pkl,
    )
    val_dataset = Classification_ImageDataset(
        root_dir=cfg.imagenet_val_data_dir,
        #image_paths_pkl=cfg.image_paths_pkl,
    )
